...
class Controller:
    ...
    def show_receive_order(self, rider_id):
        ...
        if rider == None:
            return f"rider_id : {rider_id} not found"
        return [self.show_order_detail(order.order_id) for order in rider.recieve_order_list]
    ...
    def add_customer_account_by_request(self, password, username, telephone_number, email, fullname):
        ...
        return {key : value for key, value in customer_attribute.items() if key == '_Account__account_id' or key == '_Account__profile' or key == '_Account__password'}
    ...
    def add_restaurant_account_by_request(self,password, username, telephone_number, email, fullname):
        ...
        return {key : value for key , value in new_restaurant_account_attribute.items() if key != '_Account__pocket' and key != '_RestaurantAccount__restaurant_list'}
    ...
    def add_rider_account_by_request(self,password, username, telephone_number, email, fullname):
        ...
        return {key : value for key, value in new_rider_account_attribute.items() if key == '_Account__account_id' or key == '_Account__profile' or key == '_Account__password'}
    ...
    def show_restaurant_approval_list(self):
        ...
        for restaurant in self.approval_restaurant_list:
            restaurant_attribute = {'restaurant_id' : restaurant.restaurant_id, 'name' : restaurant.name_restaurant, 'menu' : restaurant.food_list}
    ...
    def new_restaurant(self, username : str, request: Restaurant_body):
        ...
        for restaurant_acc in self.restaurant_account_list:
            if restaurant_acc.get_name() == username:
                restaurant = Restaurant(request.name_restaurant, request.restaurant_location,[],[],[],[],restaurant_acc)

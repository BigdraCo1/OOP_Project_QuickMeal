...
customer_account1.current_order = order1
customer_account1.current_order = order2
rider_account1.current_order = order1
rider_account1.current_order = order2
restaurant4.current_order_list = order1
restaurant4.current_order_list = order2
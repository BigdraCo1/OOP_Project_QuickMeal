...
@app.get("/show/{restaurant}", status_code=status.HTTP_200_OK)
...
@app.put("/update/{restaurant}/{menu}", status_code=status.HTTP_202_ACCEPTED)
...
@app.delete("/delete/{restaurant}/{menu}", status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/new/{restaurant}", status_code=status.HTTP_201_CREATED)
